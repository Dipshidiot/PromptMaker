...
| Element | Realistic | Stylized |
|---------|-----------|----------|
| Lighting | Plausible sources only | Dramatic, mood-driven, color-tinted |
| Color | True-to-life | Enhanced; palette pushed toward style |
| Texture | Photographic | Style-defined surface |
...
| Subject | Stylized Output Description |
|---------|------------------------------|
| A tired office worker | Cartoonishly wide eyes, loading-icon pupils, saturated yellow wash, JPEG grain aesthetic, bold warped text |
| A cat in a garden | Impressionistic brushwork, saturated greens and golds, soft bokeh pushed to near-abstract, expressive fur |
| A futuristic city | Neon bloom on every surface, color-graded teal/magenta split, rain rendered as light streaks |
